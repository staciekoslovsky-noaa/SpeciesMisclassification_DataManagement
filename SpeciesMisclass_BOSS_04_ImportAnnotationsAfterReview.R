# Process species misclassification data to the DB: BOSS
...
project_schema <- "surv_boss"
wd <- "J:\\SpeciesMisclassification\\JoBSS\\Quartile1"
reviews <- "JoBSS_Quartile1Review_SpeciesID_SMW.csv"
reviewer <- "SMW"
review_description <- "boss_review"

##### JoBSS Quartile 3 Variables
# project_schema <- "surv_jobss"
# wd <- "J:\\SpeciesMisclassification\\JoBSS\\Quartile3"
